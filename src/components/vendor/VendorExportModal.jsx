...
import { VENDOR_EXPORT_FIELDS } from '../../lib/exportUtils'

export default function VendorExportModal({ selectedKeys, onExport, onClose }) {
  ...
  function toggleAll() {
    setKeys(prev => prev.length === VENDOR_EXPORT_FIELDS.length ? [] : VENDOR_EXPORT_FIELDS.map(f => f.key))
  }
