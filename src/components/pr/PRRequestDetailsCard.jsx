...
export default function PRRequestDetailsCard({ pr }) {
  ...
  return (
    <>
      {pr.ai_summary && (
        <div style={{ background: 'var(--taupe-50)', border: '1px solid var(--taupe-200)', borderRadius: 'var(--radius-md)', padding: '14px 18px', marginBottom: '12px' }}>
      ...
      {Number(pr.advance_percent) >= 100 && (
        <div style={{ background: 'var(--clay-bg)', border: '1px solid var(--clay-border)', borderLeft: '4px solid var(--clay)', borderRadius: 'var(--radius-xs)', padding: '10px 14px', marginBottom: '12px' }}>
      ...
      <div style={{ background: 'var(--surface-card)', border: '1px solid var(--taupe-200)', borderRadius: 'var(--radius-md)', padding: '20px', marginBottom: '12px' }}>
        <div style={{ fontSize: '11px', fontWeight: 700, color: 'var(--ink)', textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: '14px' }}>Request Details (as submitted)</div>
      ...
      {pr.single_source_justification && (
        <div style={{ background: 'var(--surface-card)', border: '1px solid var(--taupe-200)', borderRadius: 'var(--radius-md)', padding: '20px', marginBottom: '12px' }}>
          <div style={{ fontSize: '11px', fontWeight: 700, color: 'var(--ink)', textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: '10px' }}>Single Source Justification</div>
          <div style={{ fontSize: '13px', color: 'var(--ink)', whiteSpace: 'pre-wrap', lineHeight: 1.6 }}>{pr.single_source_justification}</div>
        </div>
      )}
